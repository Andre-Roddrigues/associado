...
// import logoUnitecEnglish from "@/public/images/languagecentericon.png"
// import { InView } from "@/components/ui/in-view";
// export function LanguageSection() {
//     return (
//         <section className='h-96 lg:h-[45vh] mt-4 relative  flex bg-[url("/images/LANGUAGEMOBILE2.jpg")] w-full lg:bg-[url("/images/LANGUAGE.jpeg")] w bg-left-top bg-no-repeat lg:bg-cover  bg-fixed'>
//             <div className="h-full p-4 flex flex-col justify-center  gap-3 lg:p-10  w-full  opacity-95 bg-gradient-to-r from-blue-800 to-cyan-600 clip-path-halfClipMobile lg:clip-path-halfClip " >
//                 <InView
//                     variants={{
//                         hidden: {
//                             opacity: 0,
...
import ParallaxImage from "./test";
import ContentLanguage from "./Content";

export function LanguageSection() {
  return (
    <section className="h-96 lg:h-[45vh] mt-4 w-full">
     <ParallaxImage/>
