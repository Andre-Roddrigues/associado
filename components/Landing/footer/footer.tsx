...
export default function Footer() {
  return (
    <footer className="bg-gradient-darkblue-light text-white py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
        <div className="mt-6">
            <h4 className="text-sm font-semibold text-gray-400 mb-3">REDES SOCIAIS</h4>
          ...
          {/* Contact Info */}
          <div className="mt-6">
            <h3 className="text-sm font-semibold text-gray-400 mb-3">CONTACTOS</h3>
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-300">info@unitec.cursos</span>
              </li>
            </ul>
          </div>
        </div>        
